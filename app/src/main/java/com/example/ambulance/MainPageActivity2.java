...
public class MainPageActivity2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
public class MainPageActivity2 extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem)
    {
        ...
        if (id == R.id.nav_profile)
        {
            Intent p=new Intent(MainPageActivity2.this,ProfileDriver.class);
            startActivity(p);
            finish();
        }
        else if (id == R.id.nav_gallery)
        ...
        else if (id==R.id.nav_signOut)
        {
            ...
            databaseReference.child(firebaseUser.getUid()).child("status").setValue("offline");
            FirebaseUser user=FirebaseAuth.getInstance().getCurrentUser();
//            if(user!=null)
//            {
                //databaseReference = FirebaseDatabase.getInstance().getReference().child("Drivers");
                ...
                finish();
                //Intent myintent = new Intent(MainPageActivity.this,MainActivity.class);
                Intent myintent = new Intent(MainPageActivity2.this,firstpage.class);
                startActivity(myintent);
                finish();
//            }
//            else
...
//            }
    ...
    public void goTocheckout(View view)
    {
        Intent intent = new Intent(MainPageActivity2.this, emergency_ride_confirm.class);
        startActivity(intent);
    }
}